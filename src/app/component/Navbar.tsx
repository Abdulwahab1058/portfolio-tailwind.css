...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex justify-between items-center px-8 py-4 border-b-2 border-gray-200 bg-gray-900">
      <div className="text-2xl font-bold text-white hover:text-green-400 cursor-pointer">M.A. Wahab</div>
      <div className="flex items-center space-x-8">
        <ul className="flex space-x-8 text-white">
          <li className="menulink cursor-pointer hover:text-green-400 transition">
            <button>Home</button>
          </li>
          <li className="menulink cursor-pointer hover:text-green-400 transition">
        ...
        <button
          className="border-2 border-yellow-400 text-white px-4 py-2 rounded-lg hover:bg-green-400 hover:text-black transition duration-300"
          aria-label="Contact"
